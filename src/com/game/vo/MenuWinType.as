...
public class MenuWinType {
    ...
    public static const CLAN_OPERATE:String = "clanoperate";
    ...
    public static const TASK_HOOK_VIEW:String = "taskHookView";
    public static const HOOKER_VIEW:String = "hookerView";
    public static const CAMP_SELECT_VIEW:String = "campSelectView";
    public static const SEVEN_DAY = "seven_day";//开服七日狂欢
    ...
    public static const DAILY_BOSS:String = "daily_boss";//每日BOSS
