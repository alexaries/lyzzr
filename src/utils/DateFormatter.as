...
/*
 ...
 var str:String = "Today's date is " + DateFormatter.toCFdateFormat(date,"mmm d");
 */
public class DateFormatter {
        ...
        for (var j:uint=0; j < arMSK.length; j++) {
            ...
            switch (mskItem) {
                case "dddd":
                    ...
                    break;
                case "mmmm":
                    mskItem = monthByName(dt.getMonth()); //both are 0-based
                    break;
                case "yyyy":
                ...
                case "ddd":
                    ...
                    break;
                case "mmm":
                    mskItem = monthByAbbr(dt.getMonth()); //both are 0-based
                    break;
                case "dd":
                    mskItem = includeZero(dt.getDate());
                    break;
                case "mm":
                    mskItem = includeZero(dt.getMonth()+1); //.month is 0-based
                    break;
                case "yy":
                ...
                case "d":
                    ...
                    break;
                case "m":
                    mskItem = dt.getMonth()+1; //.month is 0-based
                    break;
                case "y":
    ...
    public static function toCFtimeFormat(dt:Date,msk:String):String {
        ...
        for (var j:uint=0; j < arMSK.length; j++) {
            ...
            switch (mskItem) {
                case "h":
                    mskItem = to12Hour(dt.getHours());
                    break;
                case "hh":
                    mskItem = includeZero(to12Hour(dt.getHours()));
                    break;
                case "H":
                    mskItem = to24Hour(dt.getHours()+1);
                    break;
                case "HH":
                    mskItem = includeZero(to24Hour(dt.getHours()));
                    break;
                case "m":
                    mskItem = dt.getMinutes();
                    break;
                case "mm":
                    mskItem = includeZero(dt.getMinutes());
                    break;
                case "s":
                    mskItem = dt.getSeconds();
                    break;
                case "ss":
                    mskItem = includeZero(dt.getSeconds());
                    break;
                case "l":
                    mskItem = dt.getMilliseconds();
                    break;
                case "ll":
                    mskItem = includeZero(dt.getMilliseconds());
                    break;
                case "t":
                    mskItem = AorP(dt.getHours());
                    break;
                case "tt":
                    mskItem = AMorPM(dt.getHours());
                    break;
            }
            arMSK[j] = mskItem;
        }
